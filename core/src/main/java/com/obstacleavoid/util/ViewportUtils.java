...
public class ViewportUtils {
    //this class will only contain  static method , therefore there is no need to instantiate the class
    ...
    public static void drawGrid(Viewport viewport, ShapeRenderer renderer, int cellSize) {// cell Size representrs how big our cell will be .by default it will be one world unit
